...
class ConfigController extends BaseController
{
    ...
    public function index()
    {
        ...
        if (IS_POST) {
            ...
            //调用API获取基本信息
             clean_query_user_cache(is_login(), array('nickname', 'sex', 'signature', 'email', 'province', 'city', 'district', 'shopname'));
            $user = query_user(array('nickname', 'signature', 'email', 'mobile', 'avatar128', 'rank_link', 'sex', 'province', 'city', 'district', 'shopname'), $aUid);
            //显示页面
    ...
    public function getExpandInfo($uid = null)
    {
        ...
        foreach ($profile_group_list as &$v) {
            $v['fields']=$this->_getExpandInfo($v['id'],$uid);
        }
     ...
     * @author 郑钟良<zzl@ourstu.com>
     */
    public function _getExpandInfo($profile_group_id = null,$uid)
    {
