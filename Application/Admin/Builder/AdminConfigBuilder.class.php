...

{
   ...
   /**键，一般用于内部调用
	...
	public function keySelectJson($name, $title, $subtitle = null, $options)

    {

        return $this->key($name, $title, $subtitle, 'selectjson', $options);
    ...
    public function keyCheckBoxJieDian($name, $title, $subtitle = null, $options)

    {

        return $this->key($name, $title, $subtitle, 'jiedian', $options);

    }

	

	public function keyMap($name, $title, $subtitle = null, $options)

    {

        return $this->key($name, $title, $subtitle, 'map', $options);

    }



    public function keyEditor($name, $title, $subtitle = null,$config='',$style = array('width'=>'90%','height'=>'400px'))

    {
	 ...
	 public function keyYear($name, $title, $subtitle = null)

    {

        return $this->key($name, $title, $subtitle, 'year');
...

    {
	 ...
	 public function keyViewImage($name, $title, $subtitle = null)

    {

        return $this->key($name, $title, $subtitle, 'viewImage');

    }

	 public function keyViewFile($name, $title, $subtitle = null)

    {

        return $this->key($name, $title, $subtitle, 'viewFile');
