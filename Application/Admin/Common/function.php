...
function get_attribute_type($type=''){
    // TODO 可以加入系统配置
    static $_type = array(
        'integer'       =>  array('数字','int(10) UNSIGNED NOT NULL'),
        'text'    =>  array('字符串','varchar(255) NOT NULL'),
        'textarea'  =>  array('文本框','text NOT NULL'),
        'time'  =>  array('时间','int(10) NOT NULL'),
        'bool'      =>  array('布尔','tinyint(2) NOT NULL'),
        'select'    =>  array('枚举','char(50) NOT NULL'),
    	'radio'		=>	array('单选','char(10) NOT NULL'),
    	'checkbox'	=>	array('多选','varchar(100) NOT NULL'),
    	'editor'    =>  array('编辑器','text NOT NULL'),
		'viewImage'    	=>  array('单图片','int(10) UNSIGNED NOT NULL'),
    	'singleImage'   =>  array('单图片+标题','text NOT NULL'), 
		'multiImage'    	=>  array('多图片+标题','text NOT NULL'),
    	'viewFile'    	=>  array('单附件','text NOT NULL'),
    );
...
function cid2name($cid){
	$info = M('ShopCategory')->where(array('id'=>$cid))->getField('title');
	return $info;
}
