...
<script src="/Application/App/Static/js/base.js"></script>
...
<header><a class="head_back" onClick="history.go(-1);">返回</a> 查找服务商家 <a class="head_search" href="<?php echo U('findservice');?>">列表</a></header>
<div id="main"></div>
...
<div class="spec-scroll"> 
  ...
  <div class="items "> 
    <ul class="icon-lists feiyue clear">
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><i alt="<?php echo ($vo["id"]); ?>" class="icon ui-icon">★</i><div  class="fontclass"><?php echo ($vo[title]); ?> </div></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
  </div>
</div>
<ul class="ullis">
  <li><a href="<?php echo U('app/demo/getmap',array('id'=>$_GET['id']));?>">首页</a><i> 　</i></li>
